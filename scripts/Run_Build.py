...
def run_backend() -> None:
    ...
    run_step(
        ...
        [BIN["uv"], "run", BIN["uvicorn"], "src.ducklearn.app:app", "--reload"],
        cwd=ROOT,
    )
...
def build_backend() -> None:
    ...
    run_step("Building Python backend (wheel via uv)...", [BIN["uv"], "build"], cwd=ROOT)


def build_frontend() -> None:
    """Build SvelteKit static frontend."""
    run_step("Building SvelteKit frontend...", [BIN["npm"], "run", "build"], cwd=FRONTEND_DIR)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Run or build DuckLearn stack.")
